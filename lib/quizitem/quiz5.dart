...
class Quiz5 extends StatefulWidget {
  ...
  @override
  State<Quiz5> createState() => _Quiz1State();
}

class _Quiz1State extends State<Quiz5> {
            ...
            return Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Text("Question ${index +1}/ ${question5.length}",
                ...
                Shoename(text: question5[index].shoename!),

                Container(
                  child: Image.asset(question5[index].picure,
                    height: 250,
                  ),
                ...
                SizedBox(height: 15,),
                for(int i = 0; i < question5[index].answer!.length; i++)
                  ...
                  Container(
                    ...
                    child: MaterialButton(
                      shape: StadiumBorder(),
                      color: isPressed ?
                      question5[index].answer!.entries.toList()[i].value
                          ? isTrue
                          : isFalse : secondColor,
                      ...
                      onPressed: isPressed ? () {}
                        ...
                        if (question5[index].answer!.entries.toList()[i].value)
                          Score += 1;
                        print(Score);
                      },
                      child: Text(question5[index].answer!.keys.toList()[i],
                        style: TextStyle(
                            color: Colors.white
                        ),
