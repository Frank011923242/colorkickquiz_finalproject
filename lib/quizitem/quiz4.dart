...
import '../quistions/question_list4.dart';
...
class Quiz4 extends StatefulWidget {
  ...
  @override
  State<Quiz4> createState() => _Quiz1State();
}
            ...
            return Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Text("Question ${index +1}/ ${question4.length}",
                ...
                Shoename(text: question4[index].shoename!),

                Container(
                  child: Image.asset(question4[index].picure,
                    height: 250,
                  ),
                ...
                SizedBox(height: 15,),
                for(int i = 0; i < question4[index].answer!.length; i++)
                  ...
                  Container(
                    ...
                    child: MaterialButton(
                      shape: StadiumBorder(),
                      color: isPressed ?
                      question4[index].answer!.entries.toList()[i].value
                          ? isTrue
                          : isFalse : secondColor,
                      ...
                      onPressed: isPressed ? () {}
                        ...
                        if (question4[index].answer!.entries.toList()[i].value)
                          Score += 1;
                        print(Score);
                      },
                      child: Text(question4[index].answer!.keys.toList()[i],
                        style: TextStyle(
                            color: Colors.white
                        ),
