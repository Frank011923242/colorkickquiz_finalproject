...
import 'package:finalproject_colorkickquiz/quistions/question_list2.dart';
...
class Quiz2 extends StatefulWidget {
  ...
  @override
  State<Quiz2> createState() => _Quiz1State();
}

class _Quiz1State extends State<Quiz2> {
            ...
            return Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Text("Question ${index +1}/ ${question2.length}",
                ...
                Shoename(text: question2[index].shoename!),

                Container(
                  child: Image.asset(question2[index].picure,
                    height: 250,
                  ),
                ...
                SizedBox(height: 15,),
                for(int i = 0; i < question2[index].answer!.length; i++)
                  ...
                  Container(
                    ...
                    child: MaterialButton(
                      shape: StadiumBorder(),
                      color: isPressed ?
                      question2[index].answer!.entries.toList()[i].value
                          ? isTrue
                          : isFalse : secondColor,
                      ...
                      onPressed: isPressed ? () {}
                        ...
                        if (question2[index].answer!.entries.toList()[i].value)
                          Score += 1;
                        print(Score);
                      },
                      child: Text(question2[index].answer!.keys.toList()[i],
                        style: TextStyle(
                            color: Colors.white
                        ),
