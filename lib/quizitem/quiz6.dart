...
class Quiz6 extends StatefulWidget {
  ...
  @override
  State<Quiz6> createState() => _Quiz1State();
}
            ...
            return Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Text("Question ${index +1}/ ${question6.length}",
                ...
                Shoename(text: question6[index].shoename!),

                Container(
                  child: Image.asset(question6[index].picure,
                    height: 250,
                  ),
                ...
                SizedBox(height: 15,),
                for(int i = 0; i < question6[index].answer!.length; i++)
                  ...
                  Container(
                    ...
                    child: MaterialButton(
                      shape: StadiumBorder(),
                      color: isPressed ?
                      question6[index].answer!.entries.toList()[i].value
                          ? isTrue
                          : isFalse : secondColor,
                      ...
                      onPressed: isPressed ? () {}
                        ...
                        if (question6[index].answer!.entries.toList()[i].value)
                          Score += 1;
                        print(Score);
                      },
                      child: Text(question6[index].answer!.keys.toList()[i],
                        style: TextStyle(
                            color: Colors.white
                        ),
